...
The concept behing this alternative TSDZ2 remote enclosure is to minimize assembly time and use the existing VLCD5 button remote control as-is.
This is the keypad from the TSDZ2 original display which can also be purchased  in many online shops ie: [AliExpress](https://www.aliexpress.com/item/4001097689736.html?spm=a2g0s.9042311.0.0.27424c4dxp2RN0) 

## Design advantages

* No disassemly of the keypad is needed, plug and play operation with the remote enclosure.
