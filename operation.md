 ...
 * Double click on the [**ENTER**] button to set the LED intensity. There are 3 levels of LED intensity that can be set. Each double click will cycle through the 3 levels.
